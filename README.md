...
<br><br>
For the hamburger menu to be understandable from visually impaired, I wanted to attach both icons (to open and to close the navigation menu) an aria-label. However the W3C markup validator would show some warnings related to those. To avoid failing the validator, I got rid of those aria-labels, but I remain convinced that it was a good practice.
<br><br>
